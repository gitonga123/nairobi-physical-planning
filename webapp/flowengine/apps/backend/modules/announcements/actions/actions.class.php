...
class announcementsActions extends sfActions
{
  ...
  {
    $this->forward404Unless($announcement = Doctrine_Core::getTable('Announcement')->find(array($request->getParameter('id'))), sprintf('Object content does not exist (%s).', $request->getParameter('id')));
