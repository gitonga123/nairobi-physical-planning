...
<div class="contentpanel">
    <div class="row">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Transfer <?php echo $application->getApplicationId(); ?> to another user</h3>
        </div>
        ...
        <form method="post" action="#" class="form-bordered">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label"><?php echo __('Enter email address or ID number of the user'); ?></label><br>
                <div class="col-sm-12">
