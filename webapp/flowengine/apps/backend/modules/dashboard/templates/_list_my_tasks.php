            ...
            <th colspan="12">
                ...
                <?php if ($current_paginator->haveToPaginate()): ?>
                    <ul class="pagination pagination-sm mb0 mt0 pull-right">
                        <li><a href="/backend.php/dashboard/index/current/queued/page/1">
                                <i class="fa fa-angle-left"></i>
                            </a></li>

                        <li> <a href="/backend.php/dashboard/index/current/queued/page/<?php echo $current_paginator->getPreviousPage() ?>">
                                <i class="fa fa-angle-left"></i>
                            </a></li>
                        ...
                        <?php foreach ($current_paginator->getLinks() as $page): ?>
                            ...
                            <?php else: ?>
                                <li><a href="/backend.php/dashboard/index/current/queued/page/<?php echo $page ?>"><?php echo $page ?></a></li>
                            <?php endif; ?>
                        <?php endforeach; ?>

                        <li> <a href="/backend.php/dashboard/index/current/queued/page/<?php echo $current_paginator->getNextPage() ?>">
                                <i class="fa fa-angle-right"></i>
                            </a></li>

                        <li> <a href="/backend.php/dashboard/index/current/queued/page/<?php echo $current_paginator->getLastPage() ?>">
                                <i class="fa fa-angle-right"></i>
                            </a></li>
                    </ul>
                <?php endif; ?>
