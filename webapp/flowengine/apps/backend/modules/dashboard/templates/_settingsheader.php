...
<div class="leftpanel">
  ...
  <div class="mainpanel">
    ...
    <div class="headerbar">
      ...
      <form class="searchform" action="/backend.php/applications/search" method="post">
        <a href="/backend.php/applications/search?search=adv" class="btn btn-default pull-left btn-advanced m-t-8"><span
            class="fa fa-search"></span> <?php echo __('Advanced Search'); ?></a>
      </form>
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                <li><a href="/backend.php/dashboard/profile"><i class="glyphicon glyphicon-cog"></i>
                    <?php echo $logged_reviewer->getStrfirstname() . " " . $logged_reviewer->getStrlastname(); ?></a></li>
