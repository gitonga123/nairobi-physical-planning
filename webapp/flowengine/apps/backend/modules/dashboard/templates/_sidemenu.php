      ...
      <li class="nav-parent <?php if ($sf_context->getModuleName() == "reports") {
        ...
        <ul class="children" <?php if ($sf_context->getModuleName() == "reports") {
          ...
          <li <?php if ($sf_context->getModuleName() == "reports" && $sf_context->getActionName() == "managementR" && $sf_user->mfHasCredential("access_reports_m")) {
            ...
            <a href="<?php echo url_for('/backend.php/reports/managementR?dashboard=788ea657-2af2-4afd-b7a0-1a566dba7373') ?>"><i class="fa fa-area-chart"></i> <span><?php echo __('Management Reports'); ?></span></a>
          ...
          <li <?php if ($sf_context->getModuleName() == "reports" && $sf_context->getActionName() == "professionals" && $sf_user->mfHasCredential("access_reports_m")) {
            ...
            <a href="<?php echo url_for('/backend.php/reports/professionals?dashboard=0c8a1850-860b-45c5-87e4-e2f405ed618c') ?>"><i class="fa fa-bar-chart-o"></i><span><?php echo __('Registered Users') ?></span></a>
          </li>
          <li <?php if ($sf_context->getModuleName() == "reports" && $sf_context->getActionName() == "revenue" && $sf_user->mfHasCredential("access_reports_m")) {
                echo 'class="active"';
              } ?>>
            <a href="<?php echo url_for('/backend.php/reports/revenue?dashboard=b6ebd20e-595e-4364-9281-b5e9590b10b4') ?>"><i class="fa fa-bar-chart-o"></i><span><?php echo __('Revenue') ?></span></a>
          </li>
