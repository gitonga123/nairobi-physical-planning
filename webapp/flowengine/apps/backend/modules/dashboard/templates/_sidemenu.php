      ...
      <li class="nav-parent <?php if ($sf_context->getModuleName() == "reports") {
        ...
        <ul class="children" <?php if ($sf_context->getModuleName() == "reports") {
          ...
          <li <?php if ($sf_context->getModuleName() == "reports" && $sf_context->getActionName() == "embed" && $sf_user->mfHasCredential("access_reports_m")) {
            ...
            <a href="<?php echo url_for('/plan/reports/professionals?dashboard=788ea657-2af2-4afd-b7a0-1a566dba7373') ?>"><i class="fa fa-area-chart"></i> <span><?php echo __('Management Reports'); ?></span></a>
          ...
          <li <?php if ($sf_context->getModuleName() == "reports" && $sf_context->getActionName() == "professionals" && $sf_user->mfHasCredential("access_reports_m")) {
            ...
            <a href="<?php echo url_for('/plan/reports/professionals?dashboard=0c8a1850-860b-45c5-87e4-e2f405ed618c') ?>"><i class="fa fa-bar-chart-o"></i><span><?php echo __('Registered Professionals') ?></span></a>
          </li>
