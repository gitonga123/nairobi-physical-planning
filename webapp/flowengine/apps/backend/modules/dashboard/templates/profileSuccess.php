    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="first_name" class="form-control" value="<?php echo $reviewer->getStrfirstname(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">Last Name</label>
            <div class="col-sm-8">
                <input type="text" name="last_name" class="form-control" value="<?php echo $reviewer->getStrlastname(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">ID Number</label>
            <div class="col-sm-8">
                <input type="text" name="id_number" class="form-control" value="<?php echo $reviewer->getStruserid(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">Email</label>
            <div class="col-sm-8">
                <input type="text" name="email" class="form-control" value="<?php echo $reviewer->getStremail(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">Mobile Number</label>
            <div class="col-sm-8">
                <input type="text" name="phone_number" class="form-control" value="<?php echo $reviewer->getStrphoneMain1(); ?>">
            </div>
          </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="country" class="form-control" value="<?php echo $reviewer->getStrcountry(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">City</label>
            <div class="col-sm-8">
                <input type="text" name="city" class="form-control" value="<?php echo $reviewer->getStrcity(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">Designation</label>
            <div class="col-sm-8">
                <input type="text" name="designation" class="form-control" value="<?php echo $reviewer->getUserdefined1Value(); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4">Man Number</label>
            <div class="col-sm-8">
                <input type="text" name="mannumber" class="form-control" value="<?php echo $reviewer->getUserdefined2Value(); ?>">
            </div>
          </div>
      </div>
      <div class="modal-footer">
