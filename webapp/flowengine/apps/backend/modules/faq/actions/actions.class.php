...
class faqActions extends sfActions
{
  ...
  {
    $this->forward404Unless($faq = Doctrine_Core::getTable('Faq')->find(array($request->getParameter('id'))), sprintf('Object content does not exist (%s).', $request->getParameter('id')));
