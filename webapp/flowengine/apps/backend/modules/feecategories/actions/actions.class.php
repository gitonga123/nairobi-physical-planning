...
/**
 * feecategoriesactions.
 *
 * @package    backend
 * @subpackage feecategories
 * @author     Thomas Juma
 * @version    2.5: 2017-01-24
 */
class feecategoriesActions extends sfActions
{
  /**
  ...
  {
    $this->forward404Unless($category = Doctrine_Core::getTable('FeeCategory')->find(array($request->getParameter('id'))), sprintf('Object content does not exist (%s).', $request->getParameter('id')));
    
    $this->form = new FeeCategoryForm($category);
