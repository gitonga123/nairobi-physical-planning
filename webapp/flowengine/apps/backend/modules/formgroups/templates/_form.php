<?php
	use_helper("I18N");
?>
<form  action="/backend.php/formgroups/<?php echo ($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getGroupId() : ''); ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>   autocomplete="off" data-ajax="false" class="form-bordered">
    ...
    <div class="panel-heading">
      ...
      <?php echo $form->renderGlobalErrors() ?>
		...
		<div class="panel-heading text-right">
          <a class="btn btn-primary" id="newpage" href="/backend.php/formgroups/index" ><?php echo __('Back to List'); ?></a>
    </div>
