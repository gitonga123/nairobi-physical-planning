<?php
	...
	require($prefix_folder.'includes/report-functions.php');
	...
	$header_data =<<<EOT
<link type="text/css" href="/form_builder/css/jquery_minicolors.css" rel="stylesheet" />
			...
			<div class="post edit_widget">
				...
				<div class="content_body">
					...
					<ul id="ew_main_list" style="margin-bottom: 25px" data-formid="<?php echo $form_id; ?>" data-charttype="<?php echo $chart_type; ?>" data-chartid="<?php echo $chart_id; ?>">
							...
							<div id="ew_box_widget_data" class="ew_box_main gradient_blue">
								...
								<div class="ew_box_content">
									...
									<label class="description" for="ew_chart_enable_filter" style="margin-top: 20px">
										Data Option 
										<img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="By default, the widget will be based on all entries data. You can enable filter to generate the widget based on specific set of data."/>
									</label>
									...
									<div id="widget_filter_pane" <?php if(empty($chart_enable_filter)){ echo 'style="display: none"'; } ?>>
										...
										<li id="li_1" class="filter_settings <?php echo $filter_date_class; ?>">
											...
											<span style="display:none"><img id="datepickimg_1" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger filter_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
											<a href="#" id="deletefilter_1" class="filter_delete_a"><img src="/form_builder/images/icons/51_blue_32.png" width="16" height="16" /></a>
										...
										<li id="li_<?php echo $i; ?>" class="filter_settings <?php echo $filter_date_class; ?>">
											...
											<span style="display:none"><img id="datepickimg_<?php echo $i; ?>" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger filter_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
											<a href="#" id="deletefilter_<?php echo $i; ?>" class="filter_delete_a"><img src="/form_builder/images/icons/51_blue_32.png" width="16" height="16" /></a>
										</li>
										...
										<li id="li_filter_add" class="filter_add" style="text-align: right">
											<a href="#" id="filter_add_a"><img src="/form_builder/images/icons/49_blue_32.png" width="16" height="16" /></a>
										</li>
									</ul>
						...
						<li class="ps_arrow"><img src="/form_builder/images/icons/33_orange.png" /></li>
						<li>
									...
									<ul id="ew_widget_options_list">
										<li id="li_chart_theme" style="width: 162px; float: left"> 
											<label class="description" for="ew_chart_theme" style="margin-top: 2px"> Theme
												<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Select the color scheme of your widget."/>
											</label>
										...
										<li id="li_background_color" style="width: 160px; margin-left: 25px;float: left;display: <?php if($show_background_color_property){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<div class="minicolors_container" >
												<label class="description" style="margin-top: 2px"> Background Color
													<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Leave this empty to use transparent background color (recommended)."/>
												</label>
										...
										<li id="li_line_style" style="width: 162px; clear: both; padding-top: 10px; margin-top: 10px;display: <?php if($show_line_style_property){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<label class="description" for="ew_chart_line_style" style="margin-top: 2px"> Graph Line Style
												<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Select the line style of the graph."/>
											</label>
										...
										<li id="li_bar_color" style="width: 362px;padding-top: 10px; margin-top: 15px; border-top: 1px dashed #DF8F7D;display: <?php if($show_bar_color_property){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<div class="minicolors_container" >
												<label class="description" style="margin-top: 2px"> Bar Color
													<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Leave this empty to use default color provided by the widget theme."/>
												</label>
										...
										<li id="li_date_range" style="width: 362px;padding-top: 10px; margin-top: 15px; border-top: 1px dashed #DF8F7D;display: <?php if($show_date_range_property){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<label class="description" for="ew_chart_date_range" style="margin-top: 2px"> Date Range
												<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Select the range of your entries submission date that your chart will be based on. If you have set any filter previously, this date range will be applied on top of that filter."/>
											</label>
												...
												<ul id="li_date_range_custom">
													<li style="float: left; width: 45%">
														...
														<span style="display:none">
															<img id="datepickimg_chart_date_range_start" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger" style="vertical-align: top; cursor: pointer" />
														</span>
													</li>
													<li style="float: left; width: 45%">
														...
														<span style="display:none">
															<img id="datepickimg_chart_date_range_end" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger" style="vertical-align: top; cursor: pointer" />
														</span>
													</li>
										...
										<li id="li_grid_page_size" style="width: 162px;margin-top:10px; float: left;display: <?php if($chart_type == 'grid'){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<label class="description" for="ew_grid_page_size" style="margin-top: 2px">Rows Per Page
												<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="The number of rows of data to appear on each page. Minimum value is 1."/>
											</label>
										...
										<li id="li_grid_max_length" style="width: 160px;margin-top:10px;margin-left: 25px;float: left;display: <?php if($chart_type == 'grid'){ echo 'block'; }else{ echo 'none'; } ?>"> 
											<label class="description" for="ew_grid_max_length" style="margin-top: 2px">Cell Max Length
												<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="The maximum number of characters can be displayed in each cell of the grid. Leave this empty or enter 0 to remove any limit (NOTE: This might cause your grid to load slower)."/>
											</label>
							...
							<div id="ew_box_widget_size" class="ew_box_main gradient_green">
								...
								<div class="ew_box_content">
									<label class="description" for="ew_chart_height" style="margin-top: 10px">
										Widget Height 
										<img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="The width of your widget will be automatically calculated based on the height you set here and based on the width of the container where you embed the widget."/>
									</label>
...
<script type="text/javascript" src="/form_builder/js/edit_widget.js"></script>
EOT;
