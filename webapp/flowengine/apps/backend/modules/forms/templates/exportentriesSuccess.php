<?php
	...
	$form_properties = mf_get_form_properties($dbh,$form_id,array('payment_enable_merchant','payment_ask_billing','payment_ask_shipping'));
	...
	while($row = mf_do_fetch_result($sth)){
		...
		$element_option_lookup[$element_id][$option_id] = $row['option_text'];
	}
	...
	if($export_type == 'xls'){
		require($prefix_folder.'lib/pear/Spreadsheet/Excel/Writer.php');
