<?php
	...
	if(!empty($row)){
        ...
        $logic_workflow_enable = (int) $row['logic_workflow_enable'];
		...
		$jquery_data_code .= "\$('.logic_settings').data('logic_status',{\"logic_field_enable\": {$logic_field_enable} ,\"logic_page_enable\": {$logic_page_enable} ,\"logic_email_enable\": {$logic_email_enable},\"logic_webhook_enable\": {$logic_webhook_enable},\"logic_workflow_enable\": {$logic_workflow_enable},\"logic_success_enable\": {$logic_success_enable} });\n";
	}
	...
	while($row = mf_do_fetch_result($sth)){
		...
		$options_lookup[$element_id][$option_id] = htmlspecialchars($row['option_text'],ENT_QUOTES);
	}
	...
	/** Workflow Logic **/
    //get data from ap_workflow_logic_elements table
    $query = "SELECT
                        A.form_id,
                        A.element_id,
                        A.rule_show_hide,
                        ...
                        B.element_page_number
                    FROM
                        ".MF_TABLE_PREFIX."workflow_logic_elements A LEFT JOIN ".MF_TABLE_PREFIX."form_elements B
                      ON
                        A.form_id = B.form_id and A.element_id=B.element_id and B.element_status = 1
                   WHERE
                        A.form_id = ?
    ...
    $workflow_elements_array = array();
    $all_workflow_elements_id = array();

    while($row = mf_do_fetch_result($sth)){
        $element_id = (int) $row['element_id'];

        $workflow_elements_array[$element_id]['rule_show_hide'] 	= $row['rule_show_hide'];
        $workflow_elements_array[$element_id]['rule_all_any'] 		= $row['rule_all_any'];
        $workflow_elements_array[$element_id]['element_position'] 	= $row['element_position'];
        $workflow_elements_array[$element_id]['element_page_number'] = $row['element_page_number'];
        ...
        $workflow_elements_array[$element_id]['element_title'] = $row['element_position'].'. '.$element_title;

        $all_logic_elements_id[] = $element_id;
    }

    //get data from ap_workflow_logic_conditions table
    $query = "select target_element_id,element_name,rule_condition,rule_keyword from ".MF_TABLE_PREFIX."workflow_logic_conditions where form_id = ? order by alc_id asc";
    $params = array($form_id);
    $sth = mf_do_query($query,$params,$dbh);

    $workflow_conditions_array = array();
    $prev_element_id = 0;
    ...
    while($row = mf_do_fetch_result($sth)){
        ...
        $workflow_conditions_array[$target_element_id][$i]['element_name']   = $row['element_name'];
        $workflow_conditions_array[$target_element_id][$i]['rule_condition'] = $row['rule_condition'];
        $workflow_conditions_array[$target_element_id][$i]['rule_keyword']   = $row['rule_keyword'];
			...
			<div class="post logic_settings">
				...
				<div class="content_body">
					...
					<ul id="ls_main_list">
						<li>
							<div id="ls_box_field_rules" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="Enable this option to show or hide fields on the form based on the value of another fields. Useful for displaying different set of fields based on user choices."/>
								</div>
															...
															<thead>
																<tr>
																	<td title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>">
																		<strong title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>"><?php echo $element_title; ?></strong><a class="delete_lifieldrule" id="deletelifieldrule_<?php echo $element_id; ?>" href="#"><img src="/form_builder/images/icons/52_blue_16.png"></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		<h6>
																			<img src="/form_builder/images/icons/arrow_right_blue.png" style="vertical-align: top" />
																		...
																		<ul class="ls_field_rules_conditions">
																			...
																			?>
																				...
																				<li id="lifieldrule_<?php echo $element_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					...
																					<input type="hidden" value="" class="rule_datepicker" name="datepicker_<?php echo $element_id.'_'.$i; ?>" id="datepicker_<?php echo $element_id.'_'.$i; ?>">
								 		 											<span style="display:none"><img id="datepickimg_<?php echo $element_id.'_'.$i; ?>" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger condition_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
																					<a href="#" id="deletecondition_<?php echo $element_id.'_'.$i; ?>" name="deletecondition_<?php echo $element_id.'_'.$i; ?>" class="a_delete_condition"><img src="/form_builder/images/icons/51_blue_32.png" width="16" height="16" /></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $element_id; ?>" class="a_add_condition"><img src="/form_builder/images/icons/49_blue_32.png" width="16" height="16" /></a>
																			</li>
																		</ul>
																	</td>
																</tr>
						...
						<li>
							<div id="ls_box_page_rules" class="ns_box_main gradient_red">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Enable this option to allow users to jump into the success page or go to any specific page based on their choices. Useful when you have multipage form and need to display different set of pages based on user choices."/>
								</div>
													...
													<li id="lipagerule_<?php echo $page_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong><?php echo $page_title; ?></strong><a class="delete_lipagerule" id="deletelipagerule_<?php echo $page_id; ?>" href="#"><img src="/form_builder/images/icons/52_red_16.png"></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		<h6>
																			<img src="/form_builder/images/icons/arrow_right_red.png" style="vertical-align: top" />
																			 Go to this page if 
																		...
																		<ul class="ls_page_rules_conditions">
																			...
																			?>
																				...
																				<li id="lipagerule_<?php echo $page_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					...
																					<input type="hidden" value="" class="rule_datepicker" name="datepicker_<?php echo $page_id.'_'.$i; ?>" id="datepicker_<?php echo $page_id.'_'.$i; ?>">
								 		 											<span style="display:none"><img id="datepickimg_<?php echo $page_id.'_'.$i; ?>" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger condition_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
																					<a href="#" id="deletecondition_<?php echo $page_id.'_'.$i; ?>" name="deletecondition_<?php echo $page_id.'_'.$i; ?>" class="a_delete_condition"><img src="/form_builder/images/icons/51_red_16.png" /></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $page_id; ?>" class="a_add_condition"><img src="/form_builder/images/icons/49_red_16.png" /></a>
																			</li>
																		</ul>
																	</td>
																</tr>
						...
						<li>&nbsp;</li>
						<li>
                        <div id="ls_box_workflow_rules" class="ns_box_main gradient_blue">
                        <div class="ns_box_title">
                            <input type="checkbox" value="1" class="checkbox" id="logic_workflow_enable" <?php if(!empty($logic_workflow_enable)){ echo 'checked="checked"'; } ?> name="logic_workflow_enable">
                            <label for="logic_workflow_enable" class="choice"><?php echo __('Enable Rules to Override Workflow'); ?></label>
                            <img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="Enable this option to override where new submissions go in the workflow"/>
                        </div>
                        <div class="ls_box_content" <?php if(empty($logic_workflow_enable)){ echo 'style="display: none"'; } ?>>
                        <label class="description" for="ls_select_workflow_rule" style="margin-top: 2px">
                            <?php echo __('Select a field that will Override the workflow'); ?>
                        </label>
                        <select class="select medium" id="ls_select_workflow_rule" name="ls_select_workflow_rule" autocomplete="off">
                            <option value=""></option>
                            <?php
                            for ($i=1; $i <= $form_page_total ; $i++) {
                                if($form_page_total > 1){
                        ...
                        <select class="select medium" id="ls_select_workflow_rule_lookup" name="ls_select_workflow_rule_lookup" autocomplete="off" style="display: none">
                            <option value=""></option>
                            <?php
                            for ($i=1; $i <= $form_page_total ; $i++) {
                                if($form_page_total > 1){
                        ...
                        <select id="ls_workflow_lookup" name="ls_workflow_lookup" autocomplete="off" class="element select condition_fieldname" style="width: 260px;display:none">
                            <?php
                            foreach ($field_labels as $element_name => $element_label) {
                        ...
                        <ul id="ls_workflow_rules_group">
                        <?php
                        if(!empty($workflow_elements_array)){

                            foreach ($workflow_elements_array as $element_id => $value) {
                                ...
                                $jquery_data_code .= "\$(\"#liworkflowrule_{$element_id}\").data('rule_properties',{\"element_id\": {$element_id},\"rule_show_hide\":\"{$rule_show_hide}\",\"rule_all_any\":\"{$rule_all_any}\"});\n";
                                ?>

                                <li id="liworkflowrule_<?php echo $element_id; ?>">
                                <table width="100%" cellspacing="0">
                                <thead>
                                <tr>
                                    <td title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>">
                                        <strong title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>"><?php echo $element_title; ?></strong><a class="delete_liworkflowrule" id="deleteliworkflowrule_<?php echo $element_id; ?>" href="#"><img src="/form_builder/images/icons/52_blue_16.png"></a>
                                    </td>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <h6>
                                    <img src="/form_builder/images/icons/arrow_right_blue.png" style="vertical-align: top" />
                                    <select style="margin-left: 5px;margin-right: 5px" name="workflowruleshowhide_<?php echo $element_id; ?>" id="fieldruleshowhide_<?php echo $element_id; ?>" class="element select rule_show_hide">
                                        <option value="show" <?php if($rule_show_hide == 'show'){ echo 'selected="selected"'; } ?>><?php echo __('Override'); ?></option>
                                    </select> <?php echo __('workflow if '); ?>
                                    <select style="margin-left: 5px;margin-right: 5px" name="workflowruleallany_<?php echo $element_id; ?>" id="fieldruleallany_<?php echo $element_id; ?>" class="element select rule_all_any">
                                        <option value="any" <?php if($rule_all_any == 'any'){ echo 'selected="selected"'; } ?>><?php echo __('any'); ?></option>
                                    </select> <?php echo __('of the following conditions match'); ?>:
                                </h6>
                                <ul class="ls_workflow_rules_conditions">
                                    <?php
                                    $current_element_conditions = array();
                                    $current_element_conditions = $workflow_conditions_array[$element_id];
                                    ...
                                    foreach ($current_element_conditions as $value) {
                                        ...
                                        $jquery_data_code .= "\$(\"#liworkflowrule_{$element_id}_{$i}\").data('rule_condition',{$json_rule_condition});\n";
                                        ...
                                        <li id="liworkflowrule_<?php echo $element_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>

                                            <select name="conditiontext_<?php echo $element_id.'_'.$i; ?>" id="conditiontext_<?php echo $element_id.'_'.$i; ?>" class="element select condition_text" style="width: 120px;<?php echo $condition_text_display; ?>">
                                                <option <?php if($value['rule_condition'] == 'is'){ echo 'selected="selected"'; } ?> value="is"><?php echo __('If value is'); ?></option>
                                            </select>

                                            <input type="text" class="element text condition_keyword" value="<?php echo $rule_keyword; ?>" id="conditionkeyword_<?php echo $element_id.'_'.$i; ?>" name="conditionkeyword_<?php echo $element_id.'_'.$i; ?>" style="<?php echo $condition_keyword_display; ?>">
                                            <br>
 											Send the application to the following stage: <br>
                                             ...
                                             <select id="conditionfield_<?php echo $element_id.'_'.$i; ?>" name="conditionfield_<?php echo $element_id.'_'.$i; ?>" autocomplete="off" class="element select condition_fieldname" style="width: 260px;">
                                                ...
                                                foreach($stagegroups as $stagegroup)
                                                {
                                                    ...
                                                    foreach($stages as $stage)
                                                    {
                                                        ...
                                                        if($condition_element_name == $stage->getId()){
                                            ...
                                            <input type="hidden" value="" class="rule_datepicker" name="datepicker_<?php echo $element_id.'_'.$i; ?>" id="datepicker_<?php echo $element_id.'_'.$i; ?>">
                                            <span style="display:none"><img id="datepickimg_<?php echo $element_id.'_'.$i; ?>" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger condition_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
                                            <a href="#override" id="deletecondition_<?php echo $element_id.'_'.$i; ?>" name="deletecondition_<?php echo $element_id.'_'.$i; ?>" class="a_delete_condition"><img src="/form_builder/images/icons/51_blue_16.png" /></a>
                                        </li>
                                    ...
                                    <li class="ls_add_condition">
                                        <a href="#override" id="addcondition_<?php echo $element_id; ?>" class="a_add_condition"><img src="/form_builder/images/icons/49_blue_16.png" /></a>
                                    </li>
                                </ul>
                                </td>
                                </tr>
						...
						<li>
							<div id="ls_box_email_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="Enable this option to send additional notification emails to any email address based on user choices. You can customize the email content, subject, and from address based on user choices."/>
								</div>
								<div class="ls_box_content" <?php if(empty($logic_email_enable)){ echo 'style="display: none"'; } ?>>									
												...
												<li id="liemailrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_liemailrule" id="deleteliemailrule_<?php echo $rule_id; ?>" href="#"><img src="/form_builder/images/icons/52_green_16.png"></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<ul class="ls_email_rules_conditions">
																			...
																			?>
																				...
																				<li id="liemailrule_<?php echo $rule_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					...
																					<input type="hidden" value="" class="rule_datepicker" name="datepicker_<?php echo $rule_id.'_'.$i; ?>" id="datepicker_<?php echo $rule_id.'_'.$i; ?>">
								 		 											<span style="display:none"><img id="datepickimg_<?php echo $rule_id.'_'.$i; ?>" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger condition_date_trigger" style="vertical-align: top; cursor: pointer" /></span>
																					<a href="#" id="deletecondition_<?php echo $rule_id.'_'.$i; ?>" name="deletecondition_<?php echo $rule_id.'_'.$i; ?>" class="a_delete_condition"><img src="/form_builder/images/icons/51_green_16.png" /></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $rule_id; ?>" class="a_add_condition"><img src="/form_builder/images/icons/49_green_16.png" /></a>
																			</li>
																		</ul>
																		<h6>
																			<img src="/form_builder/images/arrows/arrow_right_green.png" style="vertical-align: middle;margin-right: 5px" width="26px"/> Send email to: 
																		...
																		<h6 style="margin-bottom: 0px;padding-bottom: 2px">
																			<img src="/form_builder/images/arrows/arrow_right_green.png" style="vertical-align: middle;margin-right: 5px" width="26px"/> Using email template:  
																		...
																		<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																			<div class="ls_email_rules_delay_notification" id="ls_email_rules_delay_notification_div_<?php echo $rule_id; ?>" <?php if($rule_properties->template_name == 'custom'){ echo 'style="display: none"'; } ?>>
																				...
																				<label for="emaildelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label> <img class="helpmsg" src="/form_builder/images/icons/68_green_whitebg.png" style="vertical-align: top" title="If enabled, notification email will only being sent when payment is made successfully."/>	
																			</div>
																		<?php } ?>
																		...
																		<div class="ls_email_rules_custom_template" id="ls_email_custom_template_div_<?php echo $rule_id; ?>" <?php if($rule_properties->template_name != 'custom'){ echo 'style="display: none"'; } ?>>
																			...
																			<div class="ls_email_rules_custom_template_body">
																				...
																				<label class="description" for="customemailbcc_<?php echo $rule_id; ?>">Bcc <img class="helpmsg" src="/form_builder/images/icons/68_green_whitebg.png" style="vertical-align: top" title="Blind Carbon Copy Addresses. This is OPTIONAL. You can enter multiple email addresses, simply separate them with commas."/></label>
																				...
																				<label class="description" for="customemailcontent_<?php echo $rule_id; ?>">Email Content <img class="helpmsg" src="/form_builder/images/icons/68_green_whitebg.png" style="vertical-align: top" title="This field accept HTML codes."/></label>
																				...
																				<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																					<span style="display: block;margin-top: 10px">
																						...
																						<label for="customemaildelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label> <img class="helpmsg" src="/form_builder/images/icons/68_green_whitebg.png" style="vertical-align: top" title="If enabled, notification email will only being sent when payment is made successfully."/>	
																					</div>
																				<?php } ?>

																				<span class="ns_temp_vars"><img style="vertical-align: middle" src="/form_builder/images/icons/70_green_white.png"> You can insert <a href="#" class="tempvar_link">merge tags</a> into Email Subject and Email Content.</span>
																			</div> 
																		</div>
									...
									<div id="ls_email_add_rule_div">
										...
										<img style="vertical-align: top;margin-left: 3px" src="/form_builder/images/icons/49_orange_16.png">
									</div>
								</div>
						...
						<li>
							<div id="ls_box_webhook_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="This is ADVANCED option. Enable this option to send additional webhooks to any other URLs based on user choices."/>
								</div>
												...
												<li id="liwebhookrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_liwebhookrule" id="deleteliwebhookrule_<?php echo $rule_id; ?>" href="#"><img src="/form_builder/images/icons/52_green_16.png"></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<h6>
																			<img src="/form_builder/images/arrows/arrow_right_green.png" style="vertical-align: middle;margin-right: 5px" width="26px"/> Send form data to URL: 
																		...
																		<h6 style="margin-bottom: 0px;padding-bottom: 2px">
																			<img src="/form_builder/images/arrows/arrow_right_green.png" style="vertical-align: middle;margin-right: 5px" width="26px"/> Using the following settings:  
																		</h6>
																		<div class="ls_webhook_options" id="ls_webhook_options_div_<?php echo $rule_id; ?>">
																			...
																			<div class="ls_webhook_options_body">
																				...
																				<div class="webhook_http_header_div" id="webhook_http_header_div_<?php echo $rule_id; ?>" <?php if(empty($rule_properties->webhook_enable_custom_http_headers)){ echo 'style="display: none"'; } ?>>
																					<label class="description" style="margin-top: 10px" for="webhookcustomhttpheaders_<?php echo $rule_id; ?>">HTTP Headers <img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="A JSON object of all HTTP Headers you need to send."/></label>
																				...
																				<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																					<span style="display: block;margin-top: 10px">
																						...
																						<label for="webhookdelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label>  <img class="helpmsg" src="/form_builder/images/icons/68_green_whitebg.png" style="vertical-align: top" title="If enabled, webhook will only being sent when payment is made successfully."/>	
																					</span>
																				<?php } ?>
																				...
																				<div class="webhook_raw_div" id="webhook_raw_div_<?php echo $rule_id; ?>" <?php if($rule_properties->webhook_format == 'key-value'){ echo 'style="display: none"'; } ?>>
																					<label class="description" style="border-bottom: 1px dashed #97BF6B;padding-bottom: 10px;margin-bottom: 15px">Raw Data <img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="Enter any content you would like to send here. You can use any data format (e.g. JSON, XML or raw text). Just make sure to set the proper 'Content-Type' HTTP header as well."/></label>
																					...
																					?>	
																						<li class="ns_url_params">
																							...
																							<div class="ns_param_control">
																								<a class="delete_webhook_param" name="deletewebhookparam_<?php echo $clean_rule_id.'_'.$i; ?>" id="deletewebhookparam_<?php echo $clean_rule_id.'_'.$i; ?>" href="#"><img src="/form_builder/images/icons/51_green_16.png"></a>
																							</div>
																						</li>
																					<?php $i++;} ?>
																					
																					<li class="ns_url_add_param" style="padding-bottom: 0px;text-align: right; border-top: 1px dashed #97BF6B;padding-top: 10px">
																						<a class="add_webhook_param" id="addwebhookparam_<?php echo $clean_rule_id; ?>" href="#"><img src="/form_builder/images/icons/49_green_16.png"></a>
																					</li>
																				</ul>
																				
		
																				<span class="ns_temp_vars"><img style="vertical-align: middle" src="/form_builder/images/icons/70_green_white.png"> You can insert <a href="#" class="tempvar_link">merge tags</a> into parameter values or data.</span>
																			</div> 
																		</div>
																	</td>
																</tr>
						...
						<li>
							<div id="ls_box_success_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="Enable this option to display custom success page or redirect to any custom URL based on user choices. This will override your default form success page."/>
								</div>
												...
												<li id="lisuccessrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_lisuccessrule" id="deletelisuccessrule_<?php echo $rule_id; ?>" href="#"><img src="/form_builder/images/icons/52_green_16.png"></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<h6 style="float: left;margin-right: 10px;margin-bottom: 0px;">
																			<img src="/form_builder/images/arrows/arrow_right_green.png" style="vertical-align: middle;margin-right: 5px" width="26px"/> On Success Page: 
																		</h6>	
																		<div style="float: left">	
																			<span>
																		...
																		<span class="ns_temp_vars" style="margin-left: 35px"><img style="vertical-align: middle" src="/form_builder/images/icons/70_green_white.png"> You can insert <a href="#" class="tempvar_link">merge tags</a> into Success Message or Redirect URL.</span>
																	</td>
																</tr>
															</tbody>
														</table>
...
<script type="text/javascript" src="/form_builder/js/jquery-ui/ui/jquery.effects.pulsate.js"></script>
...
<script type="text/javascript" src="/form_builder/js/logic_settings.js"></script>
EOT;
