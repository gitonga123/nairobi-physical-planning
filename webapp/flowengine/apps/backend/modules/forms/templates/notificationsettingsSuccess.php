<?php
	...
	if(!empty($_POST['form_id'])){
		...
		$form_input['esl_bcc_email_address'] = $notification_settings['esl_bcc_email_address'];
		$form_input['esr_bcc_email_address'] = $notification_settings['esr_bcc_email_address'];
		...
		$ssl_suffix = mf_get_ssl_suffix();						
		header("Location: /backend.php/forms/index?id={$form_id}&hl=1");
		exit;
				...
				<div class="content_header">
					<div class="content_header_title">
						<div style="float: left">
							<h2><?php echo "<a class=\"breadcrumb\" href='/backend.php/forms/index?id={$form_id}'>".$form_name.'</a>'; ?> <span class="icon-arrow-right2 breadcrumb_arrow"></span> Notification Settings</h2>
							<br>
						...
						<li>
							<div id="ns_box_myinbox" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="Enable this option to send all successful form submission to your email address (all the data will still be accessible from your machform admin panel as well)."/>
								</div>
								<div class="ns_box_email" <?php if(empty($esl_enable)){ echo 'style="display: none"'; } ?>>
									<label class="description" for="esl_email_address">Your Email Address <img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="You can enter multiple email addresses. Simply separate them with commas."/></label>
								...
								<div class="ns_box_more" style="display: none">
									<label class="description" for="esl_bcc_email_address">Bcc <img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="Blind Carbon Copy Addresses. This is OPTIONAL. You can enter multiple email addresses, simply separate them with commas."/></label>
									...
									<label class="description" for="esl_content">Email Content <img class="helpmsg" src="/form_builder/images/icons/68_blue.png" style="vertical-align: top" title="This field accept HTML codes."/></label>
									...
									<span class="ns_temp_vars"><img style="vertical-align: middle" src="/form_builder/images/icons/70_blue.png"> You can insert <a href="#" class="tempvar_link">merge tags</a> into Email Subject and Email Content.</span>
								...
								<div class="ns_box_more_switcher" <?php if(empty($esl_enable)){ echo 'style="display: none"'; } ?>>
									...
									<img id="myinbox_img_arrow" style="vertical-align: top;margin-left: 3px" src="/form_builder/images/icons/38_rightblue_16.png">
								</div>
						...
						<li>
							<div id="ns_box_user_email" class="ns_box_main gradient_red">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Enable this option to send confirmation email to the user after successful form submission. Your form need to have an email field to use this option."/>
								</div>
								<div class="ns_box_email" <?php if(empty($esr_enable)){ echo 'style="display: none"'; } ?>>
									<?php if(!empty($email_fields)){ ?>
									<label class="description" for="esr_email_address">User Email Address <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Confirmation email will be sent to the email address being entered by the user to this field."/></label>
								...
								<div class="ns_box_more" style="display: none">
									<label class="description" for="esr_bcc_email_address">Bcc <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="Blind Carbon Copy Addresses. This is OPTIONAL. You can enter multiple email addresses, simply separate them with commas."/></label>
									...
									<label class="description" for="esr_from_name">From Name <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="If your form has 'Name' or 'Single Line Text' field type, it will be available here and you can choose it as the 'From Name' of the email. Or you can set your own custom 'From Name'"/></label>
									...
									<label class="description" for="esr_replyto_email_address">Reply-To Email <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="If your form has 'Email' field type, it will be available here and you can choose it as the reply-to address. Or you can set your own custom reply-to address."/></label>
									...
									<label class="description" for="esr_from_email_address">From Email <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="To ensure delivery of your notification emails, we STRONGLY recommend to use email from the same domain as MachForm located.<br/> e.g. no-reply@<?php echo $domain; ?>"/></label>
									...
									<label class="description" for="esr_content">Email Content <img class="helpmsg" src="/form_builder/images/icons/68_red.png" style="vertical-align: top" title="This field accept HTML codes."/></label>
									...
									<span class="ns_temp_vars"><img style="vertical-align: middle" src="/form_builder/images/icons/70_red2.png"> You can insert <a href="#" class="tempvar_link">merge tags</a> into Email Subject and Email Content.</span>
								</div>
								<?php if(!empty($email_fields)){ ?>
								<div class="ns_box_more_switcher" <?php if(empty($esr_enable)){ echo 'style="display: none"'; } ?>>
									...
									<img id="confirmation_email_img_arrow" style="vertical-align: top;margin-left: 3px" src="/form_builder/images/icons/38_rightred_16.png">
								</div>
								<?php } ?>
							</div>
						</li>
						...
						<li>
							<div id="ns_box_url_notification" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="This is ADVANCED option. You can enable this option to send form data to any other custom URL. Useful to integrate your form with many other web applications, such as Aweber, MailChimp, Salesforce, CampaignMonitor, etc."/>
								</div>
								<div class="ns_box_content" <?php if(!empty($webhook_enable)){ echo 'style="display: block"'; } ?>>
									...
									<div id="ns_http_header_div" <?php if(empty($webhook_enable_custom_http_headers)){ echo 'style="display: none"'; } ?>>
										<label class="description" style="margin-top: 10px" for="webhook_custom_http_headers">HTTP Headers <img class="helpmsg" src="/form_builder/images/icons/68_green.png" style="vertical-align: top" title="A JSON object of all HTTP Headers you need to send."/></label>
										...
										?>	
											<li class="ns_url_params">
												...
												<div class="ns_param_control">
													<a class="a_delete_webhook_param" name="deletewebhookparam_<?php echo $i; ?>" id="deletewebhookparam_<?php echo $i; ?>" href="#"><img src="/form_builder/images/icons/51_green_16.png"></a>
												</div>
											</li>
										<?php $i++;} ?>
										
										<li class="ns_url_add_param" style="padding-bottom: 0px;text-align: right; border-top: 1px dashed #97BF6B;padding-top: 10px">
											<a class="a_add_condition" id="ns_add_webhook_param" href="#"><img src="/form_builder/images/icons/49_green_16.png"></a>
										</li>
									</ul>
									
									<span class="ns_temp_vars"><img src="/form_builder/images/icons/70_green_white.png" style="vertical-align: middle"> You can insert <a class="tempvar_link" href="#">merge tags</a> into parameter values or data.</span>
...
<script type="text/javascript" src="/form_builder/js/notification_settings.js"></script>
EOT;
