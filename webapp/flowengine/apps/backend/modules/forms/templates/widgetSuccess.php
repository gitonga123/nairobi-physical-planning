...
<head>
    ...
    <link href="/form_builder/js/kendoui/styles/kendo.<?php echo $chart_theme; ?>.min.css" rel="stylesheet">
    
    <link href="/form_builder/js/kendoui/styles/kendo.dataviz.min.css" rel="stylesheet">
  	<link href="/form_builder/js/kendoui/styles/kendo.dataviz.<?php echo $chart_theme; ?>.min.css" rel="stylesheet">
