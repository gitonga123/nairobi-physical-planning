<?php
    /**
     * _listinfo.php template.
     *
     * Shows client additional details
     *
     * @package    backend
     * @subpackage frusers
...
?>  <div class="form-group"><label class="col-sm-2"><i class="bold-label"><?php if(strlen($data['label']) < 200){ echo $data['label']; }else{ echo substr($data['label'],0,100)."........"; } ?></i></label>
      <div class="col-sm-10"><?php if(strlen($data['value']) > 0){ echo nl2br($data['value']); }else{ echo "<i> - not defined - </i>"; } ?></div>
 	</div>
