				...
				<tbody>
					<tr>
						<td class="form-group border-bottom-0">
							<select size="1" name="table2_length" aria-controls="table2" class="select2"
								onChange="window.location='/backend.php/invoices/index/filter/' + this.value;">
						...
						<td style="width:10%; border:0px;" class="form-group border-bottom-0 radius-tr">
							<form style="margin:0" action="#" method="post">
								...
								<?php endif; ?>
								<input type='hidden' name='export' id='export' value='1'><button
									class="btn btn-default btn-xs table-billing-btn btn-excell" type="submit">E<span
										class="hidden-xs">xport</span></button>
							</form>
						</td>
					</tr>
				</tbody>
					...
					<tr>
						<form method="post" action="/backend.php/invoices/index">
							...
							<th class="border-bottom-1" style="width:40%;">
								<select style="width:40%;" size="1" name="filter_status" aria-controls="table2"
									class="select2">
									...
									<option value="15" <?php if ($filter_status == "15") {
										echo "selected='selected'";
									} ?>>
										<?php echo __('Part Payment') ?>
									</option>
									<option value="2" <?php if ($filter_status == "2") {
										echo "selected='selected'";
									} ?>>
										<?php echo __('Paid') ?>
									</option>
									<option value="3" <?php if ($filter_status == "3") {
										echo "selected='selected'";
									} ?>>
							...
							<th class="border-bottom-1">
								<input name="fromdate" value="<?php echo $fromdate; ?>" type="text"
									class="form-control  datepicker p10" placeholder="Starting From">
							</th>
							<th class="border-bottom-1">

								<input name="todate" value="<?php echo $todate; ?>" type="text"
									class="form-control datepicker p10" placeholder="Ending">
							</th>
							<th style="width:10%;" class="border-bottom-1">
								<button type="submit" class="btn table-billing-btn btn-default">G<span
										class="hidden-xs">O</span></button>
							</th>
						</form>
					</tr>
				</thead>
