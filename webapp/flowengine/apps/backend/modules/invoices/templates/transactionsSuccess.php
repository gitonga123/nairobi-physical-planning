		...
		<div class="panel-body panel-body-nopadding">
				...
				<tbody>
					<tr>
						<td class="form-group border-bottom-0">
							<select size="1" name="table2_length" aria-controls="table2" class="select2" onChange="window.location='/plan/invoices/transactions/filter/' + this.value;">
			...
			<table class="table table-striped table-hover mb0 border-top-0 border-left-0 border-right-0 panel-table">
				<thead class="form-horizontal">
					<tr>
						<form method="get" action="/plan/invoices/transactions">
							<?php if ($filter) : ?>
