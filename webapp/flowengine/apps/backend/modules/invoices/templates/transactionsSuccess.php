...
/**
 * transactionsSuccess.php template.
 *
 */
use_helper("I18N");
		...
		<div class="panel-body panel-body-nopadding">
				...
				<tbody>
					<tr>
						<td class="form-group border-bottom-0">
							<select size="1" name="table2_length" aria-controls="table2" class="select2" onChange="window.location='/backend.php/invoices/transactions/filter/' + this.value;">
			...
			<table class="table table-striped table-hover mb0 border-top-0 border-left-0 border-right-0 panel-table">
				<thead class="form-horizontal">
					<tr>
						<form method="get" action="/backend.php/invoices/transactions">
							<?php if ($filter) : ?>
			...
			$('#payments').DataTable({
				...
				"ajax": {
					...
					error: function() {
						...
						$("#payments_processing").css("display", "none");
					},
					complete: function() {
						$("#payments_processing").css("display", "none");
					}
