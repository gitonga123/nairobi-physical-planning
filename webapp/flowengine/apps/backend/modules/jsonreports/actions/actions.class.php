...
class jsonreportsActions extends sfActions
{
  ...
  {
    $this->forward404Unless($report = Doctrine_Core::getTable('Reports')->find(array($request->getParameter('id'))), sprintf('Object content does not exist (%s).', $request->getParameter('id')));
    
    $this->form = new ReportsForm($report);
