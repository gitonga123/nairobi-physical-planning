        ...
        <button onClick="window.location = '/plan/reports/report13export/fromdate/<?php echo $fromdate; ?>/todate/<?php echo $todate; ?>';">Export to excel</button>
            <table>
                    <thead>
                            ...
                            <th>Name of Project/Developer</th>
                            <th>Submitted By</th>
                            <th>TIN</th>
                            <th>Plot No</th>
			...
			<?php
                        ...
                        $sql = "SELECT * FROM ap_form_47 WHERE date_created BETWEEN '".$fromdate."' AND '".$todate."'";
			...
			while($row = mysql_fetch_assoc($results))
                        {
                            $q = Doctrine_Query::create()
                               ->from("FormEntry a")
                               ->where("a.form_id = ? AND a.entry_id = ?", array("47",$row['id']))
