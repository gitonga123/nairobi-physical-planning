...
<div class="contentpanel">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo __('Approvals/Rejections Report'); ?></h3>
        </div>

        <div class="panel-heading text-right">
              <a class="btn btn-primary" id="export" href="/backend.php/reports/printreport6" ><?php echo __('Export'); ?></a>
