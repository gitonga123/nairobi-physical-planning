...
<div class="contentpanel">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo __('Filter Applications By Dropdown'); ?></h3>
        </div>

        <div class="panel-heading text-right">
              <a class="btn btn-primary" id="export" href="/backend.php/reports/printreportfilter" ><?php echo __('Export'); ?></a>
