...
?>
   ...
   <div class="pageheader">
       <h2> <i class="fa fa-share-square-o"></i> Share  <?php if($application->getApproved() == "0")
					{
						echo "DRAFT-".$application->getId();
					}
					else
					{
         ...
         <form class="form-horizontal form-bordered" action="<?php echo public_path('backend.php/share/share/id/'.$application->getId()); ?>" method="post">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label"><?php echo __('Enter the email of a registered user and click find') ?></label>
               <div class="col-sm-6">
               <input required name="filter" id="filter" alt="filter" class="form-control" type="text" size="20" value="<?php if($filter && $filter != ""){ echo $filter; }else{ ?>Email of registered user...<?php } ?>"  onblur="if(this.value=='') this.value='Email of registered user...';" onfocus="if(this.value=='Email of registered user...') this.value='';"  />
               </div>
            </div>
              ...
              <div class="panel-footer">
                <button class="btn btn-primary"><?php echo __('Find') ?></button>
              </div><!-- panel-footer -->
            </div><!-- panel-default -->
          </form>
...
?>
 ...
 <div class="panel panel-default">
           ...
           <div class="panel-heading">
             ...
             <h4 class="panel-title">Select a user with whom you want to share your application</h4>
