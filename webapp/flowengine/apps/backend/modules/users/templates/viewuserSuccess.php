...
<div class="pageheader">
    <h2><i class="fa fa-user"></i> <?php echo __('Profile'); ?><span><?php echo __("View reviewer details"); ?></span>
    </h2>
...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo $reviewer->getStrfirstname() . " " . $reviewer->getStrlastname(); ?></h3>
            <?php echo __("Reviewer Informaiton"); ?>
        </div>
        ...
        <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body padding-0">
                            <table class="table table-vertical m-b-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $reviewer->getStrfirstname() . " " . $reviewer->getStrlastname(); ?>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            if ($sf_user->mfHasCredential("access_reviewers")) {
                                                ...
                                                <a href="" class="btn btn-xs btn-info" data-toggle="modal"
                                                    data-target="#passwordModal"><span class="fa fa-lock"></span>
                                                    <?php echo __("Reset Password"); ?></a>
                                                <a href="" class="btn btn-xs btn-primary" data-toggle="modal"
                                                    data-target="#userModal"><span class="fa fa-edit"></span> </a>
                                                <?php
                                            }
                                            ?>
                                        </td>
            ...
            <div class="panel panel-default">
                ...
                if ($sf_user->mfHasCredential("access_reviewers")) {
                    ?>
                    <div class="panel-heading text-right">
                        <a href="" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#otherModal"><span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($groups as $group) {
                                        if (!strpos($group->getName(), 'System Administrators')) {
                                            echo $group->getName() . ",";
                                        }
                                    }
                                    ?>
            ...
            <div class="panel with-nav-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab1default" data-toggle="tab"><span class="fa fa-tasks"></span>
                                <?php echo __("Current tasks"); ?></a></li>
                        <li><a href="#tab2default" data-toggle="tab"><span class="fa fa-bars"></span>
                                <?php echo __("Completed Tasks"); ?></a></li>
                        <li><a href="#tab3default" data-toggle="tab"><span class="fa fa-times"></span>
                                <?php echo __("Canceled Tasks"); ?></a></li>
                        <li><a href="#tab4default" data-toggle="tab"><span class="fa fa-history"></span>
                                <?php echo __("Audit log"); ?></a></li>
                    </ul>
                </div>
                <div class="panel-body padding-0">
                        ...
                        <div class="tab-pane fade in active" id="tab1default">
                            ...
                            <table class="table table-striped table-hover table-special m-t-20 m-b-0">
                                    ...
                                    foreach ($current_paginator->getResults() as $task) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="word-wrap:break-word; width: 250px;">
                                                ...
                                                <h1><?php echo html_entity_decode($application->getStage()->getMenus()->getTitle()); ?>
                                                </h1>
                                                <p><?php echo date('d F Y H:m:s', strtotime($application->getDateOfSubmission())); ?>
                                                </p>
                                            </td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                <a class='btn btn-default btn-xs' title='<?php echo __('View Task'); ?>'
                                                    href='<?php echo public_path("backend.php/tasks/view/id/" . $task->getId()); ?>'><span
                                                        class="fa fa-eye"></span></a>
                                                <?php
                                                if ($sf_user->mfHasCredential("has_hod_access")) {
                                                    ?>
                                                    <a title="Cancel Task" class="btn btn-danger btn-xs"
                                                        href="<?php echo public_path("backend.php/tasks/cancel/id/" . $task->getId()); ?>"><span
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="12">
                                            <p class="table-showing pull-left">
                                                <strong><?php echo count($current_paginator) ?></strong>
                                                <?php echo __('Tasks'); ?>
                            ...
                            <table class="table table-striped table-hover table-special m-t-20 m-b-0">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="12">
                                            <p class="table-showing pull-left">
                                                <strong><?php echo count($completed_paginator) ?></strong>
                                                <?php echo __('Tasks'); ?>
                            ...
                            <table class="table table-striped table-hover table-special m-t-20 m-b-0">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="12">
                                            <p class="table-showing pull-left">
                                                <strong><?php echo count($cancel_paginator) ?></strong>
                                                <?php echo __('Tasks'); ?>
                            ...
                            <table class="table table-striped table-hover table-special m-t-20 m-b-0">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="12">
                                            <p class="table-showing pull-left">
                                                <strong><?php echo count($audit_paginator) ?></strong>
                                                <?php echo __('Audit logs'); ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="auditModalLabel"
        aria-hidden="true">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="first_name" class="form-control"
                                    value="<?php echo $reviewer->getStrfirstname(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Last Name</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="last_name" class="form-control"
                                    value="<?php echo $reviewer->getStrlastname(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">ID Number</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="id_number" class="form-control"
                                    value="<?php echo $reviewer->getStruserid(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Email</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="email" class="form-control"
                                    value="<?php echo $reviewer->getStremail(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Mobile Number</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="phone_number" class="form-control"
                                    value="<?php echo $reviewer->getStrphoneMain1(); ?>">
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="auditModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="#" method="post" enctype="multipart/form-data">
    ...
    <!-- Modal -->
    <div class="modal fade" id="otherModal" tabindex="-1" role="dialog" aria-labelledby="auditModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="country" class="form-control"
                                    value="<?php echo $reviewer->getStrcountry(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">City</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="city" class="form-control"
                                    value="<?php echo $reviewer->getStrcity(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Designation</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="designation" class="form-control"
                                    value="<?php echo $reviewer->getUserdefined1Value(); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Man Number</label>
                            <div class="col-sm-8">
                                <input type="text" id="from-multiple" name="mannumber" class="form-control"
                                    value="<?php echo $reviewer->getUserdefined2Value(); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <!-- Modal -->
    <div class="modal fade" id="accessModal" tabindex="-1" role="dialog" aria-labelledby="auditModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="#" method="post" enctype="multipart/form-data">
