...
class zonesActions extends sfActions
{
  ...
  {
    $this->forward404Unless($zone = Doctrine_Core::getTable('Zones')->find(array($request->getParameter('id'))), sprintf('Object content does not exist (%s).', $request->getParameter('id')));
    
    $this->form = new ZonesForm($zone);
    $this->setLayout("layout-settings");
  }
