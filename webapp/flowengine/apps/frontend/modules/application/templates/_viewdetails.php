<div class="card flex-fill">
	<div class="card-header text-end">
		...
		?>
			<a href="/index.php/application/edit/id/<?php echo $application->getId(); ?>" class="btn btn-outline-danger btn-sm text-end"><span class="fa fa-edit"></span> <?php echo __("Edit &amp; Resubmit"); ?></a>
		<?php
		} else {
		?>
