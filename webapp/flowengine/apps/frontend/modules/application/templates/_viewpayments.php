                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-info btn-sm" id="printinvoice"
                                href="/index.php/invoices/view/id/<?php echo $invoice->getId(); ?>"><i class="fa fa-eye mr5"></i>
                                <?php echo __("View Invoice"); ?></a> |
                            <a class="btn btn-dark btn-sm" id="printinvoice"
                                href="/index.php/invoices/printinvoice/id/<?php echo $invoice->getId(); ?>"><i
                            ...
                            <?php if ($invoice->getPaid() == 1 || $invoice->getPaid() == 15) { ?>
                                | <a class="btn btn-primary btn-sm" id="makeinvoice"
                                    href="/index.php/forms/payment?id=<?php echo $application->getFormId(); ?>&app_id=<?php echo $application->getEntryId(); ?>&invoice=<?php echo $invoice->getId(); ?>">
