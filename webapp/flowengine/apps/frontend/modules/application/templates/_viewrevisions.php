...
<div class="card-group" id="accordion" role="tablist" aria-multiselectable="true">
    <?php foreach ($revisions as $revision) : ?>
        <div class="card border-info">
            <div class="card-header" role="tab" id="heading<?php echo $revision->getId() ?>">
                <h4 class="card-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $revision->getId() ?>" aria-expanded="true" aria-controls="collapse<?php echo $revision->getId() ?>">
                        <?php echo $revision->getApplicationId() ?> (<?php echo $revision->getId() ?>)
                    </a>
                </h4>
            </div>
            <div id="collapse<?php echo $revision->getId() ?>" class="card-collapse collapse" role="tabcard" aria-labelledby="heading<?php echo $revision->getId() ?>">
                <div class="card-body">
