...
$param['checkbox_image'] = '/assets_unified/images/icons/59_blue_16.png';
...
<div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" class="collapsed" data-parent="#accordion1" href="#collapseTwo<?php echo $link->getId(); ?>">
                    <?php echo $form->getFormName(); ?> (Submitted on <?php echo $link->getDateOfSubmission(); ?>)
                  </a>
                </h4>
              </div>
              <div id="collapseTwo<?php echo $link->getId(); ?>" class="panel-collapse collapse <?php if($count == 1){ echo "in"; } ?>">
...
<form id="form" action="#" method="post" autocomplete="off" data-ajax="false">
    <fieldset>
        ...
        <label class="col-sm-12"><h3><?php echo $formtype ?></h3></label>
        </div>
        <?php
