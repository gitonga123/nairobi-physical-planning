...
foreach($corrections_applications as $application)
{
    ...
    <div class="alert alert-danger">
        <strong><?php echo ("Corrections!"); ?></strong> <?php echo ("You have an application that has been sent back to corrections. The following are the reasons for rejection:"); ?>
        <?php
        ...
        <ul>
            ...
            <li><?php echo $comment->getDescription(); ?> - <?php if($comment->getResolved()){ echo "<span class='label label-success'>".("Resolved")."</span>"; }else{ echo "<span class='label label-danger'>".("Not Resolved")."</span>"; } ?></li>
            <?php } ?>
        </ul>
        <strong> <a href="/index.php/application/edit/id/<?php echo $application->getId(); ?>"><?php echo ("Click here to edit and resubmit"); ?></a></strong>
    </div>
    <?php
}
