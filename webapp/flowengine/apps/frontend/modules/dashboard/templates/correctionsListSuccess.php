                    ...
                    <tbody>
                        <?php foreach ($corrections_applications as $application) : ?>
                            <tr>
                                ...
                                <td> <a class="text-primary" href="/index.php/application/view/id/<?php echo $application->getId(); ?>"><?php echo $application->getApplicationId() ?> </a></td>
                                ...
                                <td class="text-center"><a href="/index.php/application/edit/id/<?php echo $application->getId() ?>" class="btn btn-sm bg-primary-light"><i class="far fa-edit"></i> Edit & Resubmit</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
