			...
			<div style="margin: 15px;">
				...
				<div class="form_container">
					...
					<form class="form-horizontal" id="checkout_initial_payment" action="<?php echo "/index.php/forms/initiatePayment/application/{$application->getId()}/invoice/{$invoice->getId()}"; ?>">
						...
						<div class="form-group p-t-10" style="margin: 2px;">
							<button type="submit" class="btn btn-md btn-success">Initiate Payment</button>
						</div>
					</form>
				</div>
				...
				<div class="form_container">
					...
					<p>Click on one of the Payment Options</p>
					<div class="panel-group" id="accordion">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Wallet</a>
								</h4>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">M-Pesa</a>
								</h4>
							</div>
		...
		$("#checkout_initial_payment").submit(function(event) {
			...
			$.ajax({
				...
				success: function(response) {
					...
					// You can display a success message, redirect to another page, etc.
				},
