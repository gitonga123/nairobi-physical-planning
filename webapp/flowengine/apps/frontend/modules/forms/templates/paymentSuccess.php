					...
					<div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo"
						...
						<div class="accordion-body">
							<form class="form-horizontal" id="checkout_initial_payment"
								action="<?php echo '/index.php/forms/initiatePayment/application/' . $application->getId() . '/invoice/' . $invoice->getId(); ?>">
			...
			<div class="mb-3">
				...
				<div class="d-flex justify-content-between">
					<a class="btn btn-outline-info btn-block me-5"
						href="/index.php/application/view/id/<?php echo $application->getId(); ?>">Application Details</a>

					<a class="btn btn-outline-success btn-block"
						href="/index.php/invoices/view/id/<?php echo $invoice->getId(); ?>">Invoice Details</a>
