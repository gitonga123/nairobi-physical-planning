    ...
    <div class="container">
        <div class="row">
			...
			<?php $site_settings=Functions::site_settings(); ?>
                ...
                <a class="navbar-brand" href="/plan/"><span class="hidden-xs"></span><?php echo $site_settings->getOrganisationName(); ?></a>
				<?php else: ?>
                <a class="navbar-brand" href="/plan/"><span class="hidden-xs"></span><img src="<?php echo '/'.$site_settings->getUploadDir().'/'.$site_settings->getAdminImageUrl() ?>" style="margin-top:-10px" class="logo" width="150px" height="40px" alt="" /></a>
				<?php endif; ?>
            </div>
