    ...
    <div class="container">
        <div class="row">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="/index.php/"><span class="hidden-xs"><?php echo Functions::site_settings()->getOrganisationName(); ?></a>
            </div>
            <div id="navbar1" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="hidden-sm hidden-md hidden-lg <?php if($sf_context->getModuleName() == "forms"){ ?>active<?php } ?>"><a href="/index.php/forms/groups/profile/<?php echo $profile->getId(); ?>"><span class="fa fa-plus-circle"></span> <?php echo __("Make Application"); ?></a></li>
                    <li class="hidden-sm hidden-md hidden-lg <?php if($sf_context->getModuleName() == "support"){ ?>active<?php } ?>"><a href="/index.php/support/index"><span class="fa fa-question-circle"></span> <?php echo __("Support"); ?></a></li>
        ...
        <div class="row">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                  ...
                  <li class="<?php if($sf_context->getModuleName() == "forms"){ ?>active<?php } ?>"><a href="/index.php/forms/groups/profile/<?php echo $profile->getId(); ?>"><span class="fa fa-plus-circle"></span> <?php echo __("Make Application"); ?></a></li>
                  <li class="<?php if($sf_context->getModuleName() == "support"){ ?>active<?php } ?>"><a href="/index.php/support/index"><span class="fa fa-question-circle"></span> <?php echo __("Support"); ?></a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
