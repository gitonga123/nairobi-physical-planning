    ...
    <div class="card flex-fill">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <a class="card-title btn btn-dark btn-sm text-end" target="_blank" href="/index.php/application/view/id/<?php echo $invoice->getAppId(); ?>"><?php echo __("View Application"); ?></a>
            </div>
        </div>
        <div class="card-body">
            <?php
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane show active" id="solid-justified-tab1">
                        ...
                        <div class="text-end btn-invoice mt-3" style="padding-right: 10px;">
                            ...
                            <?php } else { ?>
                                <button class="btn btn-outline-dark" id="printinvoice" type="button" onClick="window.location='/index.php/invoices/printinvoice/id/<?php echo $invoice->getId(); ?>';">
