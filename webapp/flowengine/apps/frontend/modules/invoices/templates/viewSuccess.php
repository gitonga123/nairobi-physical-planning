        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <a class="card-title btn btn-dark btn-sm text-end" target="_blank"
                    href="/index.php/application/view/id/<?php echo $invoice->getAppId(); ?>"><?php echo __("View Application"); ?></a>
            </div>
        </div>
        <div class="card-body">
            <?php
                            ...
                            if ($expired) {
                                ...
                                if ($invoice->getPaid() == 1) { ?>
                                    <button class="btn btn-primary" id="makepayment" type="button"
                                        onClick="window.location='/index.php/forms/payment?id=<?php echo $invoice->getFormEntry()->getFormId(); ?>&app_id=<?php echo $invoice->getFormEntry()->getEntryId(); ?>&invoice=<?php echo $invoice->getId(); ?>';">
