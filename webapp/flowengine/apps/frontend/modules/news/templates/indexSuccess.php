            ...
            foreach($pager->getResults() as $content) {
                ...
                <article class="blog-post">
                    ...
                    <div class="fifteen columns omega">
                        <h3>
                            <a href="/index.php/news/article/id/<?php echo $content->getId(); ?>"><?php echo html_entity_decode($content->getTitle()); ?></a>
                        </h3>
                        ...
                        if (strlen($newscontent) > 400) {
                            ...
                            echo '</p><a class="readmore" href="/index.php/news/article/id/' . $content->getId() . '">'.__("Read more").'</a>';
                        } else {
