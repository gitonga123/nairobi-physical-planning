...
if(mf_is_form_submitted()){ //if form submitted
            ...
            if(!empty($submit_result['form_resume_url'])){ //the user saving a form, display success page with the resume URL
                ...
                if(is_numeric($target_page_id)){
                    ...
                    if(in_array($form_properties['payment_merchant_type'], array('stripe','authorizenet','paypal_rest','braintree','pesaflow_standard','pesaflow_cart'))){
                        ...
                        header("Location: /index.php//profile/payment?id={$input_array['form_id']}");
                        exit;
                    ...
                    header("Location: /index.php//profile/confirm?id={$input_array['form_id']}{$page_num_params}");
                    exit;
    ...
    $form_id 		= (int) trim($category->getFormId());
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="text-align: left;">
            Add a business
            <a href="/index.php//dashboard" class="btn btn-primary btn-sm pull-right" style="margin-top: -4px; color: #FFFFFF;">Back to Dashboard</a>
        </h3>
    </div>
