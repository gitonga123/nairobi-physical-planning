                            ...
                            <?php endif; ?>
									...
									<div class="form-group">
										<div class="form-check form-check-xs custom-checkbox">
											...
											<label class="form-check-label" for="agree_checkbox_user">I agree to Nairobi County Revenue Collections System</label> <a tabindex="-1" href="javascript:void(0);">Privacy Policy</a> &amp; <a tabindex="-1" href="javascript:void(0);"> Terms.</a>
										</div>
									</div>
