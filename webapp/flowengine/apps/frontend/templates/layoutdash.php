...
<body>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="nav-sidebar hidden-xs">
                    <div class="profile-card">
                        <div class="thumbnail thumbnail-reveal">
                            <?php
                            if (sfConfig::get('app_sso_authorize_url')) {
                                ...
                                <img class="img-responsive hidden-xs"
                                    src="https://account.ecitizen.go.ke/profile-picture/<?php echo $sf_user->getUsername(); ?>?t=<?php echo $account_type; ?>">
                                <?php
                            } else {
                                if ($sf_user->getProfile()->getProfilePic()) {
                                    ?>
                                    <img class="img-responsive hidden-xs"
                                        src="/assets_frontend/images/<?php echo $sf_user->getProfile()->getProfilePic() ?>">
                                    <?php
                                } else {
                                    ?>
                        ...
                        <div class="profile-info">
                            ...
                            <h4><?php echo $sf_user->getProfile()->getFullname(); ?></h4>
                            <ul class="nav user-profile-info-list">
                                <li class="user-profile-info-list-item"><?php echo __("Username"); ?>.
                                    <?php echo $sf_user->getUsername(); ?></li>
                                <li class="user-profile-info-list-item"><?php echo __("Phone"); ?>.
                                    <?php echo $sf_user->getProfile()->getMobile(); ?></li>
                                <li class="user-profile-info-list-item truncate">
                                    <?php echo $sf_user->getProfile()->getEmail(); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div
                class="<?php echo (($site_settings->getOrganisationHelp() || $site_settings->getOrganisationSidebar()) && $sf_context->getModuleName() != "application") ? 'col-sm-8' : 'col-sm-10'; ?>">
                <?php echo $sf_content ?>
            </div>
