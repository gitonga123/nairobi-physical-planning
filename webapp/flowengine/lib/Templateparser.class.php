...
class Templateparser
{
    ...
    function getInvoiceDetails($invoice_id)
    {
        ...
        $inv_fees = $inv_fees . '
                 ...
                 <tbody><tr><th width="20%" style="border-right: 1px solid #d2d2d2; padding:5px 12px; text-align:left;" nowrap>Description</th><th style="padding:5px 12px; text-align:left;" nowrap>Total Amount (' . $currency . ')</th></tr>';
        $grand_total = 0;
