...
/**
 * ApPageLogicConditions filter form base class.
 *
 * @package    permitflow
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseApPageLogicConditionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'form_id'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'target_page_id' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'target_page_id' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ap_page_logic_conditions_filters[%s]');
