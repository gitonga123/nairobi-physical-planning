...
/**
 * ApPermissionLogicConditions filter form base class.
 *
 * @package    permitflow
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseApPermissionLogicConditionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ap_permission_logic_conditions_filters[%s]');
