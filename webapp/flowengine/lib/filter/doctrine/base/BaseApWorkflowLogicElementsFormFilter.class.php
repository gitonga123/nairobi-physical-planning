...
/**
 * ApWorkflowLogicElements filter form base class.
 *
 * @package    permitflow
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseApWorkflowLogicElementsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ap_workflow_logic_elements_filters[%s]');
