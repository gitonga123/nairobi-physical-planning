...
/**
 * MfInvoiceArchive filter form base class.
 *
 * @package    permitflow
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseMfInvoiceArchiveFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mf_invoice_archive_filters[%s]');
