...
/**
 * SavedPermitArchive filter form base class.
 *
 * @package    permitflow
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSavedPermitArchiveFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'permit'             => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('saved_permit_archive_filters[%s]');
