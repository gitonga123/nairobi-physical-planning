...
/**
 * ApFieldLogicElements form base class.
 *
 * @method ApFieldLogicElements getObject() Returns the current form's model object
 *
 * @package    permitflow
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseApFieldLogicElementsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ap_field_logic_elements[%s]');
