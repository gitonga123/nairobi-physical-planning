...
/**
 * ApPermissionLogicElements form base class.
 *
 * @method ApPermissionLogicElements getObject() Returns the current form's model object
 *
 * @package    permitflow
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseApPermissionLogicElementsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ap_permission_logic_elements[%s]');
