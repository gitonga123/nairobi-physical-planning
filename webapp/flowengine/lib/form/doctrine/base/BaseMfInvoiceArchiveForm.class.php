...
/**
 * MfInvoiceArchive form base class.
 *
 * @method MfInvoiceArchive getObject() Returns the current form's model object
 *
 * @package    permitflow
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseMfInvoiceArchiveForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'app_id'          => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('mf_invoice_archive[%s]');
