...
abstract class BaseSfGuardUserCategoriesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'name'        => new sfWidgetFormInputText(array(), array('class' => 'form-control')),
      ...
      'member_no_element_id' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
      'validation_email_element_id' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
      'membership_email_match'             => new sfWidgetFormChoice(array('choices' => array(0 => 'No', 1 => 'Yes')), array('class' => 'form-control')),
      'send_verification_email'             => new sfWidgetFormChoice(array('choices' => array(0 => 'No', 1 => 'Yes')), array('class' => 'form-control')),
      'member_association_name'  => new sfWidgetFormInputText(array(), array('class' => 'form-control')),
      'member_email_verification_message'  => new sfWidgetFormTextArea(),
      'member_database' => new sfWidgetFormChoice(array('choices' => $forms_members), array('class' => 'form-control')),
      'member_database_member_no_field' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
      'member_database_member_email_field' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
      'member_database_member_name_field' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
      'member_address' => new sfWidgetFormChoice(array('choices' => array()), array('class' => 'form-control')),
