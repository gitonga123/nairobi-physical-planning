 ...
 ********************************************************************************/
	...
	$mf_lang['error_desc']			=	'Errors have been highlighted below.';
	...
	$mf_lang['val_plot_no'] 	= 	'Plot no %s has been black-listed.';
	...
	function mf_set_language($target_language){
		...
		if($target_language == 'english' || $target_language == 'en_US'){
			//simple name and extended name
			...
			$languages['error_desc']			=	'Errors have been highlighted below.';
			...
			$languages['val_plot_no'] 	= 	'Plot no %s has been black-listed.';
			//fields on excel/csv
		...
		}else if($target_language == 'arabic' || $target_language == 'ar_AR' || $target_language == 'ar_IQ'){
			//simple name and extended name
			$languages['name_first']	=	'اسم الأول';
			$languages['name_middle']	=	'اسم الثانی';
			$languages['name_last']	=	'اسم الثالث';
			$languages['name_title']	=	'عنوان';
			$languages['name_suffix']	=	'لاحقة';

			//address
			$languages['address_street']	=	'عنوان الشارع';
			$languages['address_street2']	=	'سطر العنوان 2';
			$languages['address_city']	=	'مدينة';
			$languages['address_state']	=	'الدولة / الإقليم / المنطقة';
			$languages['address_zip']	=	'البريدي / الرمز البريدي';
			$languages['address_country']	=	'بلد';

			//captcha
			$languages['captcha_required']	=	'هذه الخانة مطلوبه. الرجاء إدخال الحروف الظاهرة في الصورة.';
			$languages['captcha_mismatch']	=	'الحروف في الصورة لا تتطابق. حاول مرة أخرى.';
			$languages['captcha_text_mismatch']	=	'إجابة غير صحيحة. حاول مرة اخرى.';
			$languages['captcha_error']	=	'خطأ أثناء معالجة, يرجى المحاولة مرة أخرى.';
			$languages['captcha_simple_image_title']	=	'اكتب الحروف التي تراها في الصورة أدناه.';
			$languages['captcha_simple_text_title']	=	'حماية البريد المزعج. يرجى الإجابة على هذا السؤال بسيطة.';

			//date
			$languages['date_dd']	=	'یوم';
			$languages['date_mm']	=	'شهر';
			$languages['date_yyyy']	=	'سنة';

			//time
			$languages['time_hh']	=	'ساعة';
			$languages['time_mm']	=	'دقیقة';
			$languages['time_ss']	=	'ثانیة';


			//price
			$languages['price_dollar_main']		=	'BDT';
			$languages['price_dollar_sub']		=	'সেন্ট';
			$languages['price_euro_main']		=	'Euros';
			$languages['price_euro_sub']		=	'Cents';
			$languages['price_pound_main']		=	'Pounds';
			$languages['price_pound_sub']		=	'Pence';
			...
			//error message
			$languages['error_title']	=	'كانت هناك مشكلة مع تقريركم.';
			$languages['error_desc']	=	'كانت الأخطاء على <strong> البارز </strong> أدناه.';

			//form buttons
			$languages['submit_button']	=	'تقدیم';
			$languages['continue_button']	=	'تواصل';
			$languages['back_button']	=	'سابق';

			//form status
			$languages['form_inactive']	=	'هذا النموذج غير نشط حاليا.';
			$languages['form_limited']	=	'آسف, ولكن هذا النموذج لم يعد يقبل أية إدخالات.';

			//form password
			$languages['form_pass_title']	=	'هذا النموذج محمي بكلمة مرور.';
			$languages['form_pass_desc']	=	'الرجاء إدخال كلمة المرور الخاصة بك.';
			$languages['form_pass_invalid']	=	'كلمة المرور غير صالحة!';

			//form review
			$languages['review_title']	=	'مراجعة إدخالك';
			$languages['review_message']	=	'يرجى مراجعة دخول أدناه. انقر على زر ارسال إلى النهاية.';

			//validation message
			$languages['val_required']	=	'هذه الخانة مطلوبه. ادخل قيمه من فضلك.';
			$languages['val_required_file']	=	'هذه الخانة مطلوبه. يرجى تحميل الملف.';
			$languages['val_unique']	=	'هذا الحقل يتطلب إدخال فريد وتم بالفعل استخدام هذه القيمة.';
			$languages['val_integer']	=	'يجب أن يكون هذا الحقل عدد صحيح.';
			$languages['val_float']	=	'يجب أن يكون هذا الحقل تعويم.';
			$languages['val_numeric']	=	'يجب أن يكون هذا الحقل رقم.';
			$languages['val_email']	=	'هذا المجال ليس في شكل بريد إلكتروني صحيح.';
			$languages['val_website']	=	'هذا المجال ليس في شكل عنوان موقع ويب الصحيح.';
			$languages['val_username']	=	'قد تتكون هذا المجال فقط من a-z0-9 وسفلية.';
			$languages['val_equal']	=	'يجب أن تتطابق %s.';
			$languages['val_date']	=	'هذا المجال غير موجود في تنسيق التاريخ الصحيح.';
			$languages['val_date_range']	=	'يجب أن يكون هذا الحقل التاريخ بين %s و %s .';
			$languages['val_date_min']	=	'يجب أن يكون هذا الحقل تاريخ أكبر من أو يساوي إلى %s.';
			$languages['val_date_max']	=	'يجب أن يكون هذا الحقل التاريخ أقل من أو يساوي إلى %s.';
			$languages['val_date_na']	=	'هذا التاريخ لم يتوفر للاختيار.';
			$languages['val_time']	=	'هذا المجال غير موجود في تنسيق الوقت الصحيح.';
			$languages['val_phone']	=	'يرجى إدخال رقم هاتف صالح.';
			$languages['val_filetype']	=	'لا يسمح نوع الملف الذي تحاول تحميله.';
			$languages['val_plot_no']	=	'تم إدراج قطعة الأرض %s في القائمة السوداء';

			//fields on excel/csv
			$languages['export_num']	=	'لا.';
			$languages['date_created']	=	'تاريخ الإنشاء';
			$languages['date_updated']	=	'تاريخ التحديث';
			$languages['ip_address']	=	'IP عنوان';

			//form resume
			$languages['resume_email_subject']	=	'تم حفظ تقريركم إلى %s.';
			$languages['resume_email_content']	=	'شكرا! تقريركم إلى <b>%s </b> تم حفظ <br /> <br /> ويمكنك استئناف شكل في أي وقت عن طريق النقر على الرابط أدناه:. <br /> <a href= "%s" >%s</a> <br /> <br /> <br /> <br /> و <b> مهم: </ b> <br /> يعتبر أرسلته غير مكتملة حتى تستأنف شكل والضغط على تقديم زر واحدة.';

			$languages['resume_success_title']	=	'تم حفظ تقدمك.';
			$languages['resume_success_content']	=	'الرجاء نسخ الرابط أدناه وحفظه في مكان آمن: <BR/> %s <BR/> <BR/> يمكنك استئناف شكل في أي وقت عن طريق الذهاب الى الرابط أعلاه.';

			$languages['resume_checkbox_title']	=	'حفظ بلدي التقدم واستئناف في وقت لاحق';
			$languages['resume_email_input_label']	=	'أدخل عنوان بريدك الإلكتروني';
			$languages['resume_submit_button_text']	=	'حفظ النموذج واستئناف في وقت لاحق';
			$languages['resume_guideline']	=	'سيتم إرسال رابط خاص لاستئناف النموذج إلى عنوان البريد الإلكتروني الخاص بك.';

			//range validation
			$languages['range_type_digit']	=	'ارقام';
			$languages['range_type_chars']	=	'الحروف';
			$languages['range_type_words']	=	'كلمات';

			$languages['range_min']	=	'الحد الأدنى من %s المطلوبة.';
			$languages['range_min_entered']	=	'دخلت حاليا:%s.';

			$languages['range_max']	=	'بحد أقصى %s مسموح به.';
			$languages['range_max_entered']	=	'دخلت حاليا:%s.';

			$languages['range_min_max']	=	'يجب أن يكون بين %s و %s .';
			$languages['range_min_max_same']	=	'يجب أن تكون %s.';
			$languages['range_min_max_entered']	=	'دخلت حاليا:%s.';

			$languages['range_number_min']	=	'يجب أن يكون هناك عدد أكبر من أو يساوي إلى %s.';
			$languages['range_number_max']	=	'يجب أن يكون هناك عدد أقل من أو يساوي إلى %s.';
			$languages['range_number_min_max']	=	'يجب أن يكون رقم بين %s و %s ';

			//file uploads
			$languages['file_queue_limited']	=	'هذا المجال يقتصر على الملفات القصوى %s.';
			$languages['file_upload_max']	=	'خطأ. الحد الأقصى ل %sMB مسموح به.';
			$languages['file_type_limited']	=	'خطأ. لا يسمح هذا النوع من الملفات.';
			$languages['file_error_upload']	=	'خطأ! غير قادر على تحميل';
			$languages['file_attach']	=	'إرفاق ملفات';

			//payment page
			$languages['payment_total'] 			= 'الإجمالي';
			$languages['form_payment_header_title'] = 'الدفع';
			$languages['form_payment_title'] 		= 'Enter Payment Information';
			$languages['form_payment_description'] 	= 'الرجاء مراجعة التفاصيل أدناه قبل الإدخال معلومات الدفع';
			$languages['payment_submit_button']		= 'ادفع  تقديم الدفع';
			$languages['tax']						= 'ضريبة';

			//payment details
			$languages['payment_status']	= 'الحالة';
			$languages['payment_id']		= 'معرف الدفع';
			$languages['payment_date']	 	= 'تاريخ الدافع';
			$languages['payment_fullname'] 	= 'الاسم بالكامل';
			$languages['payment_shipping'] 	= 'عنوان الشحن';
			$languages['payment_billing']	= 'عنوان الفوترة';

			//coupon code
			$languages['coupon_not_exist'] = ' هذا الرمز القسيمة غير موجود ';
			$languages['coupon_max_usage'] = 'لقد وصلت هذه القسيمة الحد الأقصى الفداء';
			$languages['coupon_expired']   = 'لقد انتهت صلاحية هذا رمز القسيمة';
			$languages['discount']		   = 'الخصم';

			//multipage
			$languages['page_title']	=	'الصفحة %s من %s ';
		}else if($target_language == 'kurdish' || $target_language == 'ku_KU' || $target_language == 'ku_IQ'){
			//simple name and extended name
				$languages['name_first']			= 'ناوی یەکەم';
				$languages['name_middle']			= 'ناوی دووەم';
				$languages['name_last']		                = 'ناوی سێیەم';
				$languages['name_title']			= 'سەردێر';
				$languages['name_suffix']			= 'پاشگر';

				//address
				$languages['address_street']		= 'ناونیشانی شەقام';
				$languages['address_street2']		= 'ناونیشانی شەقام ٢';
				$languages['address_city']			= 'شار';
				$languages['address_state']			= 'ووڵات / هەرێم / ناوچە';
				$languages['address_zip']			= 'پۆستە / کۆدی پۆستە';
				$languages['address_country']		= 'وڵات';

				//captcha
				$languages['captcha_required']				= 'ئەم فایلە داواکراوە. تکایە ئەم پیتانە بنووسە کە لەم وێنەیە. ';
				$languages['captcha_mismatch']				= 'پیتەکانی وێنەکەت بە هەڵە نووسیووە.تکایە دووبارەی بکەوە.';
				$languages['captcha_text_mismatch'] 		= 'وەڵامەکە هەڵەیە. تکایە دووبارەی بکەوە. ';
				$languages['captcha_error']					= 'هەڵە لە کاتی پرۆسەکە هەیە. تکایە دووبارەی بکەوە. ';
				$languages['captcha_simple_image_title']	= 'ئەو پیتانە بنووسە کە لەم وێنەیەی خوارەوە دیارە. ';
				$languages['captcha_simple_text_title']		= 'پاراستنی بێزارکەر. تکایە ئەم پرسیارە ئاسانە وەڵام بدەرەوە. ';

				//date
				$languages['date_dd']				= 'ڕۆژ';
				$languages['date_mm']				= 'مانگ';
				$languages['date_yyyy']				= 'ساڵ';
				...
				//time
				$languages['time_hh']				=	'کاژێر';
				$languages['time_mm']				=	'خولەک';
				$languages['time_ss']				=	'چرکە';

				//error message
				$languages['error_title']			=	'کیشەیەک لە پێشکەشکردنەکەت هەبوو.';
				$languages['error_desc']			=	'هەڵەکان لە خوارەوە <strong>بەرچاوکراوە</strong>';

				//form buttons
				$languages['submit_button']			=	'پێشکەشکردن';
				$languages['continue_button']		=	'بەردەوامبوون';
				$languages['back_button']			=	'پێشتر';

				//form status
				$languages['form_inactive']			=	'ئەم فۆڕمە ئێستا ناچاڵاکە.';
				$languages['form_limited']			=   'ببورە، بەڵام ئەم فۆڕمە هیچ تۆمارێکی تر پەسەند ناکات.';

				//form password
				$languages['form_pass_title']		=	'ئەم فۆڕمە با ووشەی نهێنی پارێزراوە.';
				$languages['form_pass_desc']		=	'تکایە ووشەی نهێنیەکەت بنووسە.';
				$languages['form_pass_invalid']		=	'ووشەی نهێنیەکەت نادروستە!';

				//form review
				$languages['review_title']			=	'بە تۆمارەکەت بچۆرەوە.';
				$languages['review_message']		=	'تکایە بەم بەم زانیاریانەی خوارەوە بچۆرەوە. کلیک لەسەر دوگمەی پێشکەشکردن بکە بۆ تەواوبوون.';

				//validation message
				$languages['val_required'] 			=	'ئەم خانەیە داواکراوە. تکایە نرخەکەی بنووسە.';
				$languages['val_required_file'] 		=	' ئەم خانەیە داواکراوە. تکایە فایلێک ئەپلۆد بکە.';
				$languages['val_unique'] 			=	'ئەم خانەیە داوای نرخێکی تاقانە دەکات و ئەم نرخە پێشتر بەکار هاتووە. ';
				$languages['val_integer'] 			=	'ئەم خانەیە پێویستە ژمارەی راستی بێت.';
				$languages['val_float'] 			=	'ئەم خانەیە پێویستە ژمارەی کەرتی بێت';
				$languages['val_numeric'] 			=	'ئەم خانەیە پێویستە ژمارە بێت';
				$languages['val_email'] 			=	'ئیمەیڵەکەت بە شێوازێکی دروست بنووسە.';
				$languages['val_website'] 			=	'ناونیشانی ماڵەپەرەکە بە شێوازێکی دروست بنووسە. ';
				$languages['val_username'] 			=	' ئەم خانەیە تەنها a-z0-9 وە بنهێڵ (_) پەسەند دەکات. ';
				$languages['val_equal'] 			=	'%s پێویستە وەک یەک بن';
				$languages['val_date'] 			=	'بەروارەکە بە شێوازێکی دروست بنووسە';
				$languages['val_date_range'] 		=	'بەروارەکە پێویستە لە نێوان %s و %s';
				$languages['val_date_min'] 			=	'بەروارەکە پێویستە گەورەتر وە یان یەکسان بێت بە %s';
				$languages['val_date_max'] 			=	' بەروارەکە پێویستە بچووکتر وە یان یەکسان بێت بە %s';
				$languages['val_date_na'] 			=	'بەروارەکە بەردەست نیە بۆ هەڵبژاردن';
				$languages['val_time'] 			=	'نرخی ئەم خانەیە لەسەر شێوازی کاتی دروست نیە. ';
				$languages['val_phone'] 			=	'تکایە ژمارەی تەلەفۆنی دروست بنووسە.';
				$languages['val_filetype']			=	'جۆری ئەو فایلەی کە هەوڵی ئەپلۆدکردنی دەدەی ڕێگەپێنەدراوە.';

				//fields on excel/csv
				$languages['export_num']			=	'نەخێر.';
				$languages['date_created']			=	'بەروار دروستکرا';
				$languages['date_updated']			=	'بەروار نوێکراوەتەوە';
				$languages['ip_address']			=	' ناونیشانیIP';

				//form resume
				$languages['resume_email_subject']		= ' پێشکەشکردنەکەت بۆ%s پاشەکەوتکرا. ';
				$languages['resume_email_content'] 	= ' زۆر سوپاس! پێشکەشکردنەکەت بۆ <b>%s</b> پاشەکەوت کرا.<br /><br />دەتوانی هەر کاتێک پڕکردنەوەی فۆڕمەکە دەستپێبکەیتەوە بە کلیک کردن لەسەر ئەم بەستەرەی خوارەوە: <br /><a href="%s">%s</a><br /><br /><br /><br /><b>گرینگ:</b><br />پێشکەشکردنەکەت بە ناتەواو هەژمار دەکرێت تا ئەو کاتەی فۆڕمەکە بە تەواوی پڕدەکەیتەوە و دوگمەی پێشکەشکردن دادەگری.';

				$languages['resume_success_title']   	= 'پرۆسەکەت پاشەکەوت کرا.';
				$languages['resume_success_content'] 	= ' تکایە ئەم بەستەرەی خوارەوە کۆپی بکە و لە شوێنێکی پارێزراو بیپارێزە:<br/>%s<br/><br/>تۆ دەتوانی هەر کاتێک پڕکردنەوەی فۆڕمەکە دەستپێبکەیتەوە بکە کلیک کردن لەسەر ئەم بەستەرەی سەرەوە.';

				$languages['resume_checkbox_title']		= 'پرۆسەکەم پاشەکەوت بکە بۆ دەستپێکردنەوەی دواتر.';
				$languages['resume_email_input_label']	= 'ئیمەیڵی خۆت بنووسە';
				$languages['resume_submit_button_text']	= 'فۆڕمەکە پاشەکەوت بکە بۆ دەستپێکردنەوەی دواتر.';
				$languages['resume_guideline']		= 'بەستەرێکی تایبەت بە دەستپێکردنەوەی فۆڕم نێردرا بۆ ئیمەیڵەکەت.';

				//range validation
				$languages['range_type_digit']		= 'ژمارەکان';
				$languages['range_type_chars'] 		= 'پیتەکان';
				$languages['range_type_words'] 		= 'ووشەکان';

				$languages['range_min']  			= ' بچووکترین لە %s ڕیگاپێدراوە.';
				$languages['range_min_entered']   		= 'ئێستا تۆمارکراو: %s.';

				$languages['range_max']			= ' گەورەترین لە %s ڕێگاپێدراوە.';
				$languages['range_max_entered']   		= 'ئێستا تۆمارکراو: %s.';

				$languages['range_min_max'] 		= ' پێویستە لە نێوان  %s و %s بێت.';
				$languages['range_min_max_same'] 	= ' پێویستە  %s بێت.';
				$languages['range_min_max_entered'] 	= 'ئێستا تۆمارکراو: %s.';

				$languages['range_number_min']	 	= 'پێویستە ژمارەیەک بێت کە گەورەتر وە یان یەکسان بێت بە %s. ';
				$languages['range_number_max']	 	= ' پێویستە ژمارەیەک بێت کە بچووکتر وە یان یەکسان بێت بە %s. ';
				$languages['range_number_min_max'] 	= ' پێویستە ژمارەیەک بێت کە لە نێوان %s و %s بێت.';

				//file uploads
				$languages['file_queue_limited'] 		= 'ئەم خانەیە سنوردار کراوە بۆ %s فایلە.';
				$languages['file_upload_max']	   	= ' هەڵە. گەورەترین %sMB ڕێگەپێدراوە.';
				$languages['file_type_limited']  		= ' هەڵە. ئەو جۆری فایلە ڕێگە پێنەدراوە.';
				$languages['file_error_upload']  		= 'هەڵە! نەتوانرا ئەپلۆد بکرێ.';
				$languages['file_attach']		  	= 'فایلەکان هاوپێچ بکە';
			...
			$languages['file_select']		  		= 'Select Bestanden';
		...
		}else if($target_language == 'french' || $target_language == 'fr_FR'){
			//simple name and extended name
