	...
	$(function(){
		 if(is_support_html5_uploader() && $('#element_{$element->id}').length > 0){
		 	$('#element_{$element->id}').uploadifive({
		 		'uploadScript'     : 'https://devnairobi.amkatek.com/backend.php/forms/upload',
			...
			$("#element_{$element->id}_upload_link").remove();
		      ...
		      $('#element_{$element->id}').uploadify({
		        'uploader'   	  : 'https://devnairobi.amkatek.com/form_builder/js/uploadify/uploadify.swf',
		        'script'     	  : 'https://devnairobi.amkatek.com/backend.php/forms/upload',
