...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserBrowseUrl = '/assets_unified/kcfinder/browse.php?opener=ckeditor&type=files';
	config.filebrowserImageBrowseUrl = '/assets_unified/kcfinder/browse.php?opener=ckeditor&type=images';
	config.filebrowserFlashBrowseUrl = '/assets_unified/kcfinder/browse.php?opener=ckeditor&type=flash';
