...
jQuery(document).ready(function() {
   ...
   jQuery('.leftpanel .nav-parent-child > a').on('click', function() {
   ...
   function closeVisibleSubMenuChild() {
      jQuery('.leftpanel .nav-parent-child').each(function() {
         var t = jQuery(this);
         if(t.hasClass('nav-active')) {
            t.find('> ul').slideUp(200, function(){
               t.removeClass('nav-active');
