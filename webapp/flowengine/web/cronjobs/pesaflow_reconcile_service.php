...
$reconciliation_log.="/**** STARTED PESAFLOW RECONCILE SERVICE ".date("Y-m-d H:i:s")." ***/\n <br>";
...
$q = Doctrine_Query::create()
    ...
    ->andWhere("a.payment_date BETWEEN ? AND ?", array($from_date." 00:00:00", $to_date." 23:59:59"))
...
$reconciliation_log.="/**** ENDED PESAFLOW RECONCILE SERVICE ".date("Y-m-d H:i:s")." ***/\n <br>";
...
try 
{
    ...
    $notifier->sendemail($organisation_email, "thomasjgx@gmail.com","Reconciliation Log - ".$organisation_name." ".date("Y-m-d H:i:s"),$reconciliation_log);
}
catch(Exception $ex)
{
