...
$(function(){
	...
	$("#me_field_select_submit").click(function(){
		...
		$(this).after("<span id='field_select_loader'><img src='/form_builder/images/loader_small_grey.gif' style='vertical-align: middle;margin-left: 5px'/></span>");
	...
	$("#filter_add_a").click(function(){
		...
		var new_datepicker_tag = '<input type="hidden" value="" name="datepicker_'+ new_id +'" id="datepicker_'+ new_id +'">' +
								 '<span style="display:none"><img id="datepickimg_'+ new_id +'" alt="Pick date." src="/form_builder/images/icons/calendar.png" class="trigger filter_date_trigger" style="vertical-align: top; cursor: pointer" /></span>';
	...
	$("#me_clear_filter").click(function(){
		if($(this).text() == 'Clear Filter'){
			...
			$(this).text('Clearing...');
			$("#filter_info").append("<img src='/form_builder/images/loader_small_grey.gif' style='position: absolute;right: -20px;top:18px'/>");
	...
	$("#dialog-confirm-entry-delete").dialog({
		...
		buttons: [{
				...
				click: function() {
					...
					$("#btn-confirm-entry-delete-ok").after("<div class='small_loader_box'><img src='/form_builder/images/loader_small_grey.gif' /></div>");
	...
	$("#dialog-reset-entry-number").dialog({
		...
		buttons: [{
				...
				click: function() {
					...
					$("#btn-reset-entry-number-ok").after("<div class='small_loader_box'><img src='/form_builder/images/loader_small_grey.gif' /></div>");
