...
function mf_submit_payment(){
    ...
    var payment_data = {
    					...
    					card_number: mf_braintree.encrypt(mf_number),
    					card_cvc: mf_braintree.encrypt(mf_cvc),
    					card_exp_month: mf_braintree.encrypt(mf_exp_month),
    					card_exp_year: mf_braintree.encrypt(mf_exp_year),
